...
?>
	<div class="CourseListEntry">
		...
		<div class="CourseInfo">
			<h2 class="CourseInfoH2"><a href="<?php echo base_url().'index.php/course/detail/'.(string)$Course['queryCourseNo']; ?>"><div class="CourseName"><?php echo $Course['queryCourseName']; ?></div></a></h2>
